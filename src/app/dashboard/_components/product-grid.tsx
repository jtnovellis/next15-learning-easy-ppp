...
import { AddToSiteProductModalContent } from "./add-to-site-product-modal";
import { AlertDialog, AlertDialogTrigger } from "@/components/ui/alert-dialog";
import { DeleteProductDialogContent } from "./delte-product-dialog";
        ...
        <div className="flex gap-2 justify-between items-end">
          ...
          <Dialog>
            <AlertDialog>
              ...
              <DeleteProductDialogContent id={id} />
            </AlertDialog>
