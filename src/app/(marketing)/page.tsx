...
import { subscriptionTiersInOrder } from "@/data/subscription-tier";
import {
  Card,
  CardContent,
  CardDescription,
        ...
        <div className="flex flex-col sm:flex-row gap-8">
          ...
          <div className="flex flex-col gap-8">
            <FooterLinkGroup
              title="Resources"
              links={[
                { href: "#5", label: "Features" },
                { href: "#6", label: "Pricing" },
                { href: "#7", label: "About" },
              ]}
            />
          </div>
          <div className="flex flex-col gap-8">
            <FooterLinkGroup
              title="Solutions"
              links={[
                { href: "#8", label: "Features" },
                { href: "#9", label: "Pricing" },
                { href: "#10", label: "About" },
              ]}
            />
          </div>
  ...
  return (
    <Card>
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        ...
        {canRemoveBranding && <Feature>Brand Removal</Feature>}
      </CardFooter>
    </Card>
  );
}
